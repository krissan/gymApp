...
var RoutinePage = /** @class */ (function () {
    function RoutinePage(viewCtrl, navParams, _fb) {
        ...
        this.myForm = this._fb.group({
            routineName: ['', [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["f" /* Validators */].minLength(1), __WEBPACK_IMPORTED_MODULE_3__angular_forms__["f" /* Validators */].maxLength(20)]],
    ...
    RoutinePage.prototype.addSubRoutine = function (addSub) {
        //If 
        if (addSub == true) {
            var rout = new __WEBPACK_IMPORTED_MODULE_2__app_models_routine_model__["b" /* SubRoutine */]("", 0, 0);
